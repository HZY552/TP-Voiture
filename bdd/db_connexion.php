...
class db_connexion extends db_identifiants {
    private $host;
    private $db_name;
    private $username;
    private $password;
    ...
    public function afficher($table,$l1,$l2){
    ...
    public function recherche_client($value){
    ...
    public function recherche_voiture($value){
    ...
    public function get_count_number($id,$table){
